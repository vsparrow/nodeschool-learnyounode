...
const url = process.argv[2]     //node filename url
...
http.get(url,(res) => {
    ...
    // console.log(`status us ${statusCode}`)
    // console.log(`contentType us ${contentType}`)
...
//         // })
//         res.on('end', ()=>{console.log("END"); console.log(str.length)})
